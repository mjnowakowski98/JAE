...
class Server {
    constructor() {
        ...
        this.encodeFrame = function(frame) {
            ...
            let szPayloadLength = (payloadLength < 126) ? 0 : ((payloadLength < 65536) ? 2 : 8); // Bytes needed to store the length
        ...
        this.startServer = function (listenPort) {
            ...
            http.createServer((req, res) => {
                ...
                let initResponse = JSON.stringify(new ServerMessage("newConnection", null, { animationKey: client.getAnimationKey(), type:client.getRenderer().getAnimation().getType() }));
