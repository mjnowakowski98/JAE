...
class Server {
    constructor() {
        ...
        this.encodeFrame = function (frame) {
            ...
            let szPayloadLength = (payloadLength < 126) ? 0 : ((payloadLength == 126) ? 2 : 8); // Bytes needed to store the length
            ...
            if (szPayloadLength == 2) {
                ...
                // 8-Byte length (NYI)
                // Must be implemented ASAP as canvas dataURLs almost always are > 65535 bytes
                console.error("No");
                return null;
        ...
        this.startServer = function (listenPort) {
            ...
            http.createServer((req, res) => {
                ...
                let initResponse = JSON.stringify(new ResponseObject("newConnection", null, { animationKey: client.getAnimationKey() }));
        ...
        this.render = function() {
            for(let i = clients.length - 1; i >= 0; i--) {
                ...
                let message = JSON.stringify(new ResponseObject("render", null, { frameData:canvasBuffer }));
