...
class Server {
    constructor() {
        ...
        let server = null;
        this.startServer = function(listenPort, commandInterval) {
            ...
            server.listen(listenPort, () => {
                ...
                setTimeout(() => {
                    ...
                    for (let i = 0; i < clients.length; i++) {
                        let responseData = clients[i].getCommandHandler().executeNextCommand();
                        clients[i].getCommandHandler().respondNext(responseData);
                    }
                }, commandInterval);
            });
        }
